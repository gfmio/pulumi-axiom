...
SHELL            := /bin/bash
PROJECT          := github.com/gfmio/pulumi-axiom
NODE_MODULE_NAME := @gfmio/pulumi-axiom
TF_NAME          := axiom
PROVIDER_PATH    := provider
PROVIDER_VERSION := 1.1.0
VERSION_PATH     := ${PROVIDER_PATH}/pkg/version.Version
TF_PROVIDER_URL  := github.com/axiomhq/terraform-provider-axiom
...
upstream/.git:
	...
	git -c advice.detachedHead=false clone --depth 1 --branch 'v$(PROVIDER_VERSION)' 'https://github.com/axiomhq/terraform-provider-axiom' upstream
