...
def readme():
    try:
        ...
        return "axiom Pulumi Package - Development Version"


setup(name='pulumi_axiom',
      python_requires='>=3.7',
      version=VERSION,
      description="A Pulumi package for creating and managing Axiom resources",
      long_description=readme(),
      long_description_content_type='text/markdown',
      keywords='pulumi axiom category/monitoring',
      url='https://github.com/gfmio/pulumi-axiom',
      project_urls={
