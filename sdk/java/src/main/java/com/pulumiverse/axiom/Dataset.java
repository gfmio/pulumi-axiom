...
import io.gfm.pulumiaxiom.DatasetArgs;
import io.gfm.pulumiaxiom.Utilities;
import io.gfm.pulumiaxiom.inputs.DatasetState;
import java.lang.String;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="axiom:index/dataset:Dataset")
public class Dataset extends com.pulumi.resources.CustomResource {
    ...
    public Dataset(String name, @Nullable DatasetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("axiom:index/dataset:Dataset", name, args == null ? DatasetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Dataset(String name, Output<String> id, @Nullable DatasetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("axiom:index/dataset:Dataset", name, state, makeResourceOptions(options, id));
    }
