module github.com/gfmio/pulumi-axiom/provider
...
require (
	...
	terraform-provider-axiom-provider v1.1.0
)
...
require (
	...
	github.com/axiomhq/axiom-go v0.17.6 // indirect
...
replace terraform-provider-axiom-provider => github.com/axiomhq/terraform-provider-axiom v1.1.0
